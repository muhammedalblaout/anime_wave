...
class GetTopAiringUsecase implements Usecase<AnimeEpisodePage,PageParams>{
  AnimeRepository animeRepository;


  GetTopAiringUsecase(this.animeRepository);

  @override
  Future<Either<Failures, AnimeEpisodePage>> call(PageParams params)async {
    return await animeRepository.GetTopAiring(params.pagenum);
  }
